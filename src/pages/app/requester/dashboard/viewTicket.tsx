      ...
      <div className="p-4">
        <div>
          <Button
            ...
            className="bg-transparent hover:bg-transparent text-zinc-800 cursor-pointer"
          >
            <ArrowLeft />
            Voltar
          </Button>
        ...
        <div className="container mx-auto py-6 ">
          <div className="text-sm text-gray-600 mb-2">
            Central de Chamados &gt; {findTicketQuery?.ticket?.title}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg border p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Detalhes do chamado: #
                      {findTicketQuery.ticket.id.slice(0, 6)}
                    </p>
                  </div>
                  <Badge
                    className={getStatusClasses(findTicketQuery.ticket.status)}
                  >
                    {getStatusTicketInPortuguese(findTicketQuery.ticket.status)}
                  </Badge>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <Badge
                      className={getPriorityColor(
                        findTicketQuery.ticket.priority
                      )}
                    >
                      {getPriorityInPortuguese(findTicketQuery.ticket.priority)}
                    </Badge>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      {getCategoryInPortuguese(findTicketQuery.ticket.category)}
                    </p>
                  </div>
                  ...
                  <div className="text-right text-sm text-gray-500">
                    <p>
                      Criado em:{" "}
                      {new Date(
                        findTicketQuery.ticket.createdAt
            ...
            {/* Dados do Atendente */}
            {findTicketQuery.ticket.attendant && (
                ...
                <div className="bg-white rounded-lg border p-6">
                  ...
                  <div className="flex items-center mb-4">
                    <Avatar className="h-10 w-10 bg-[#f8d7f9]">
                      <AvatarFallback className="bg-[#f8d7f9] text-[#a44fb3]">
                        E
                      </AvatarFallback>
                    </Avatar>
                    <div className="ml-3">
                      <div className="flex justify-between">
                        <p className="font-medium">{findTicketQuery.ticket.attendant.name}</p>
                      </div>
                      <div className="flex justify-between">
