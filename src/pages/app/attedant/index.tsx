...
export function AtendentePage() {
  ...
  useEffect(() => {
    if (tickets?.tickets && user) {
      const current = tickets.tickets.find(
        (t) => t.attendant?.id === user.id && t.status != 3
      );
      if (current) {
        setAttendantTicket(true);
      ...
      <div className="mx-auto px-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Gerencie todos os seus chamados por aqui
          </p>
        </div>
                ...
                {tickets?.tickets &&
                  tickets.tickets
                    ...
                    .map((ticket) => (
                      <div
                        key={ticket.id}
                        className=" hover:shadow-md transition-shadow border rounded-lg bg-[#FAF9F6]"
                      >
          ...
          <div className="space-y-6">
            ...
            {!attedantTicket || !activeTicket ? (
              ...
              <Card className="p-6 space-y-4">
                ...
                {activeTicket.ticketResponses &&
                activeTicket.ticketResponses.length > 0 ? (
                  <div className="space-y-3 max-h-64 overflow-y-auto pr-2 rounded-lg p-3 ">
                    {activeTicket.ticketResponses.map(
                      (resp: {
